...
<OneLineRightIconListItem>
    BoxLayout:
        id: _right_container
        size_hint: None, None
        x: root.x + root.width - 28 # m_res.HORIZ_MARGINS - self.width
        y: root.y + root.height/2 - self.height/2
        size: dp(48), dp(48)

<OneLineLeftRightIconListItem>
    BoxLayout:
        id: _left_container
        size_hint: None, None
        x: root.x + dp(16)
...
class OneLineLeftRightIconListItem(ContainerSupport, OneLineListItem):
    # dp(40) = dp(16) + dp(24):
    _txt_left_pad = NumericProperty(dp(72))
    _txt_right_pad = NumericProperty(dp(40) + m_res.HORIZ_MARGINS)
...
class OneLineRightWidgetListItem(ContainerSupport, OneLineListItem):
    _txt_right_pad = NumericProperty(dp(40) + m_res.HORIZ_MARGINS)
