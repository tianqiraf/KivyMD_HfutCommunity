...
class BaseRectangularButton(RectangularRippleBehavior, BaseButton):
    ...
    '''
    width = BoundedNumericProperty(dp(88), min=dp(16), max=None,
...
class BaseScreenWidthRectangularButton(RectangularRippleBehavior, BaseButton):
    '''
    Abstract base class for all rectangular buttons, bringing in the
    appropriate on-touch behavior. Also maintains the correct minimum width
    as stated in guidelines.
...
class MDScreenWidthFlatButton(BaseScreenWidthRectangularButton, BaseFlatButton, BasePressedButton):
    pass
